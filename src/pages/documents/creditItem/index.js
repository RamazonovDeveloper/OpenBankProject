        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr',  gap: '30px', mt: '20px' }}>
          ...
          <Box>
            ...
            >
              ...
              <Box>
                <Box sx={{ backgroundColor: '#D2D0D0', padding: '15px 10px', borderRadius: '9px', width: '100%', minHeight:"300px", marginTop:"20px"}}>
                  <Typography sx={{ color: '#342C2C', mb: '15px' }}>Договор возмездного оказания ...</Typography>
                  {singleDocument && <iframe ref={pdfRef}  onScroll={handleScroll} width='100%' height={"300px"} src={singleDocument?.link} frameBorder='0'></iframe>}
