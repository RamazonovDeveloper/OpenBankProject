...
import AccountStatus from 'src/views/components/Status/AccountStatus'
...
const PreviewCard = ({ data, paymentId }) => {
  console.log('ACCOUNTS PREVIEW CARD PROPS IS  ......', data)

  const currentData = data.find(item => item.id == paymentId)
  ...
  return (
    currentData && (
      <Card>
        <CardContent>
          <Grid container sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '140px' }}>
            <Box>
              <Box
                sx={{
                  display: 'grid',
              ...
              >
                <Typography sx={{ fontSize: '17px' }} variant={'body'}>
                  Расчетный счет:
                </Typography>
                <Typography sx={{ color: '#342C2C', fontSize: '17px' }} variant={'body'}>
                  {currentData.account || '00000000000000000000'}
                </Typography>
              </Box>
              <Box
                sx={{
              ...
              >
                ...
                <Typography sx={{ color: '#342C2C', fontSize: '17px' }} variant={'body'}>
                  {parseSinglePaymentBalance(currentData.balance) || '0 '} UZS
                </Typography>
              </Box>
              <Box
                sx={{
              ...
              >
                ...
                <Typography sx={{ color: '#342C2C', fontSize: '17px' }} variant={'body'}>
                  <AccountStatus status={currentData.type} />
                </Typography>
              </Box>
            </Box>
            <Box>
              ...
              >
                ...
                <Typography sx={{ color: '#342C2C', fontSize: '17px', textTransform: 'capitalize' }} variant={'body'}>
                  {currentData.bank_name || 'АКБ “”'}
                </Typography>
              </Box>
              <Box
                sx={{
    ...
    //               <TableRow>
    //                 <MUITableCell>
    //                   <Typography variant='h6'>Номер счёта</Typography>
    //                 </MUITableCell>
    //                 <MUITableCell>
    //                   <Typography variant='h6'>23120000002560000000</Typography>
    //                 </MUITableCell>
    //               </TableRow>
    //               <TableRow>
    //                 <MUITableCell>
    ...
    //                 </MUITableCell>
    //                 <MUITableCell>
    //                   <Typography variant='body2'>4 200 422,00 UZS </Typography>
    //                 </MUITableCell>
    //               </TableRow>
    //               <TableRow>
    //                 <MUITableCell>
    ...
    //               <TableRow>
    //                 <MUITableCell>
    //                   <Typography variant='body1'>Вид счёта:</Typography>
    //                 </MUITableCell>
    //                 <MUITableCell>
    //                   <Typography variant='body2'>Суммовые платежи</Typography>
    //                 </MUITableCell>
    //               </TableRow>
    //               <TableRow>
    //                 <MUITableCell>
    //                   <Typography variant='body1'>История транзакций:</Typography>
    //                 </MUITableCell>
    //                 <MUITableCell>
    //                   <Typography variant='body2'>Тест</Typography>
    //                 </MUITableCell>
    //               </TableRow>
    //               <TableRow>
    //                 <MUITableCell>
    //                   <Typography variant='body1'>Дата и время последнего обновления данных по счетам:</Typography>
    //                 </MUITableCell>
    //                 <MUITableCell>
    //                   <Typography variant='body2'>Тест</Typography>
    //                 </MUITableCell>
