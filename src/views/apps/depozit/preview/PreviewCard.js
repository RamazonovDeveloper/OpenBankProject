                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <MUITableCell>
                        <Typography variant='h6'>#142104</Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='body2'>СУММА ДЕПОЗИТА: </Typography>
                      </MUITableCell>
                      <MUITableCell>
                        <Typography variant='body2'>100 000 000,00 UZS</Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='body2'>Дата оплаты:</Typography>
                      </MUITableCell>
                      <MUITableCell>
                    ...
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='body2'>Номер платёжного поручения:</Typography>
                      </MUITableCell>
                      <MUITableCell>
                    ...
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='body2'>НАКОПЛЕННАЯ СУММА:</Typography>
                      </MUITableCell>
                      <MUITableCell>
                        <Typography variant='body2'>4 300 000,00 UZS</Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='body2'>СЧЁТ:</Typography>
                      </MUITableCell>
                      <MUITableCell>
                        <Typography variant='body2'>23120000002560000000</Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='body2'>ВИД ДЕПОЗИТА :</Typography>
                      </MUITableCell>
                      <MUITableCell>
                        <Typography variant='body2'>Срочный </Typography>
                      </MUITableCell>
                    </TableRow>
                  </TableBody>
                </Table>
