...
//     <button className='main_btn gray_btn' style={{marginLeft:"0px", width:"fit-content"}}>
//         Владелец
//     </button>
//     <Box>
...
//         </Typography>
//         <Box className='myInput' sx={{display:"flex", justifyContent:"space-between", height:"55px"}}>
//             <input type="text" className='' style={{border:"none", background:"transparent", padding:"0px", width:"100%"}} defaultValue={'00.00'}/>
...
//         <Box className='myInput' sx={{display:"flex",justifyContent:"start", height:"55px"}}>
//             <img src="/images/Phone.png" alt="" style={{marginRight:"20px"}}/>
//             <input type="text" className='' style={{border:"none", background:"transparent", padding:"0px"}} defaultValue={'+998'}/>
//         </Box>
//     </Box>
//     <Box>
//         <Typography sx={{mb:'8px', fontSize:"17px"}}>
...
//         </Typography>
//         <Box className='myInput' sx={{display:"flex", justifyContent:"space-between", height:"55px"}}>
//             <input type="text" className='' style={{border:"none", background:"transparent", padding:"0px", width:"100%"}} defaultValue={''}/>
//         </Box>
//     </Box>
//     <Box>
//         <Typography sx={{mb:'8px', fontSize:"17px"}}>
...
//         </Typography>
//         <Box className='myInput' sx={{display:"flex",  height:"55px", justifyContent:"start"}}>
//             <input type="text" className='' style={{border:"none", background:"transparent", padding:"0px"}} defaultValue={'X555'}/>
//             {/* <Typography>Tashkent, Uzbekistan</Typography> */}
//         </Box>
//     </Box>
// </Box>
